...
@php
    ...
    $sb_callsign = filled(optional($flight->airline)->callsign)
        ? ' CS/' . strtoupper($flight->airline->callsign)
        : null;
    $sb_ivaova = filled(Theme::getSetting('gen_ivao_icao')) ? ' IVAOVA/' . strtoupper($flight->airline->icao) : null;
    $sb_rmk = filled(Theme::getSetting('simbrief_rmk'))
        ? ' RMK/TCAS ' . strtoupper(Theme::getSetting('simbrief_rmk'))
        : ' RMK/TCAS ' . strtoupper(config('app.name'));
@endphp
@section('content')
    <form id="sbapiform">
        <div class="row">
            <div class="col-lg-8">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $aircraft->registration }} @if ($aircraft->registration != $aircraft->name) {{ ' `' . $aircraft->name . '`' }} @endif"
                                        disabled>
                                </div>
                            ...
                            <div class="col-md-4 col-lg-2">
                                ...
                                @if (filled($aircraft->simbrief_type))
                                    <input type="hidden" id="type" name="type"
                                        value="{{ $aircraft->simbrief_type }}">
                                @else
                                    <input type="hidden" id="type" name="type"
                                        value="{{ optional($aircraft->subfleet)->simbrief_type ?? $aircraft->icao }}">
                                @endif
                            </div>
                            @if ($aircraft->fuel_onboard->local() > 0)
                                <div class="col-md-4 col-lg-2">
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text"><i class="fas fa-gas-pump"
                                                title="Fuel On Board"></i></span>
                                        <input type="text" class="form-control"
                                            value="{{ DT_ConvertWeight($aircraft->fuel_onboard, $units['fuel']) }}"
                                            disabled>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div id="specs" class="row row-cols-md-2 row-cols-lg-5 my-1">
                                <div class="col-md">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input id="dow" type="text" class="form-control text-right" value="--"
                                            disabled />
                                        <span
                                            class="input-group-text input-group-text-prepend">{{ $units['weight'] }}</span>
                                    </div>
                                </div>
                                <div class="col-md">
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text">MZFW</span>
                                        <input id="mzfw" type="text" class="form-control text-right" value="--"
                                            disabled />
                                        <span
                                            class="input-group-text input-group-text-prepend">{{ $units['weight'] }}</span>
                                    </div>
                                ...
                                <div class="col-md">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input id="mtow" type="text" class="form-control text-right" value="--"
                                            disabled />
                                        <span
                                            class="input-group-text input-group-text-prepend">{{ $units['weight'] }}</span>
                                    </div>
                                ...
                                <div class="col-md">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input id="mlw" type="text" class="form-control text-right" value="--"
                                            disabled />
                                        <span
                                            class="input-group-text input-group-text-prepend">{{ $units['weight'] }}</span>
                                    </div>
                                ...
                                <div class="col-md">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input id="maxfuel" type="text" class="form-control text-right" value="--"
                                            disabled />
                    ...
                    <div class="card-body p-1">
                        <div class="row mb-1">
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-sm">
                                    @if (!Theme::getSetting('simbrief_taxitimes'))
                                        <span class="input-group-text"><i class="fas fa-plane-departure"
                                                title="Departure"></i></span>
                                    @endif
                                    <input id="dorig" type="text" class="form-control"
                                        value="{{ $flight->dpt_airport_id }}" disabled>
                                    @if ($DBasic && Theme::getSetting('simbrief_runways'))
                                        <span class="input-group-text"><i class="fas fa-road"
                                                title="Departure Runway"></i></span>
                                        <div class="input-group-append">
                                            <select name="origrwy" class="form-control form-control-sm">
                                                <option value="">AUTO</option>
                                                @foreach (DB_GetRunways($flight->dpt_airport_id) as $dep_runway)
                                                    <option value="{{ $dep_runway->runway_ident }}">
                                                        {!! $dep_runway->ident !!}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    @endif
                                    @if ($DBasic && Theme::getSetting('simbrief_taxitimes'))
                                        <span class="input-group-text"><i class="fas fa-clock"
                                                title="Departure Taxi Time"></i></span>
                                        <select id="taxiout" name="taxiout" class="form-control form-control-sm">
                                            @for ($i = 1; $i < 30; $i++)
                                                <option value="{{ $i }}"
                                                    @if ($i == DB_AvgTaxiTime($flight->dpt_airport_id, 'out', 10)) selected @endif>{{ $i }}
                                                    min</option>
                                            @endfor
                                        </select>
                                    @endif
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-sm">
                                    @if (!Theme::getSetting('simbrief_taxitimes'))
                                        <span class="input-group-text"><i class="fas fa-plane-arrival"
                                                title="Arrival"></i></span>
                                    @endif
                                    <input id="ddest" type="text" class="form-control"
                                        value="{{ $flight->arr_airport_id }}" disabled>
                                    @if ($DBasic && Theme::getSetting('simbrief_runways'))
                                        <span class="input-group-text"><i class="fas fa-road"
                                                title="Arrival Runway"></i></span>
                                        <div class="input-group-append">
                                            <select name="destrwy" class="form-control form-control-sm">
                                                <option value="">AUTO</option>
                                                @foreach (DB_GetRunways($flight->arr_airport_id) as $arr_runway)
                                                    <option value="{{ $arr_runway->runway_ident }}">
                                                        {!! $arr_runway->ident !!}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    @endif
                                    @if ($DBasic && Theme::getSetting('simbrief_taxitimes'))
                                        <span class="input-group-text"><i class="fas fa-clock"
                                                title="Arrival Taxi Time"></i></span>
                                        <select id="taxiin" name="taxiin" class="form-control form-control-sm">
                                            @for ($i = 1; $i < 30; $i++)
                                                <option value="{{ $i }}"
                                                    @if ($i == DB_AvgTaxiTime($flight->arr_airport_id, 'in', 5)) selected @endif>{{ $i }}
                                                    min</option>
                                            @endfor
                                        </select>
                                    @endif
                            ...
                            <div class="col-md-6 col-lg-2">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input name="altn" type="text" class="form-control" maxlength="4"
                            ...
                            <div class="col-md-6 col-lg-2">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input id="fl" name="fl" type="number" class="form-control"
                                        min="0" max="99600" step="500" value="{{ $flight->level }}"
                                        onchange="CheckFL()">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="input-group input-group-sm">
                                    ...
                                    @if (Theme::getSetting('simbrief_rfinder'))
                                        @if ($Check_SSL)
                                            <a href="http://rfinder.asalink.net/free" target="_blank"
                                                class="btn btn-sm btn-secondary">RouteFinder</a>
                                        @else
                                            <button id="RouteFinder" type="button" class="btn btn-sm btn-secondary"
                                                data-toggle="modal" data-target="#rfinderModal"
                                                onclick="OpenRouteFinder()">RouteFinder</button>
                                        @endif
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="row row-cols-lg-4 mb-1">
                            <div class="col-md-4 col-lg">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text"><i class="fas fa-calendar-day"
                                            title="Date Of Flight"></i></span>
                            ...
                            <div class="col-6 col-md-4 col-lg">
                                @if ($flight->dpt_time)
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text"><i class="fas fa-plane-departure"
                                                title="Scheduled Departure Time"></i></span>
                                        <input type="text" class="form-control"
                                            value="{{ DT_FormatScheduleTime($flight->dpt_time) }}" disabled>
                                    </div>
                                @endif
                            </div>
                            <div class="col-6 col-md-4 col-lg">
                                @if ($flight->arr_time)
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text"><i class="fas fa-plane-arrival"
                                                title="Scheduled Arrival Time"></i></span>
                                        <input type="text" class="form-control"
                                            value="{{ DT_FormatScheduleTime($flight->arr_time) }}" disabled>
                                    </div>
                                @endif
                            </div>
                            <div class="col-6 col-md-4 col-lg">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text"><i class="fas fa-clock"
                                            title="Estimated Departure Time"></i></span>
                                    <input id="deph" name="deph" type="number" class="form-control text-center"
                                        min="0" max="23" maxlength="2" onchange="CheckDOF()">
                                    <span class="input-group-text px-1">:</span>
                                    <input id="depm" name="depm" type="number" class="form-control text-center"
                ...
                <div class="card mb-2">
                    <div class="card-header p-1">
                        <h5 class="m-1">
                            Load >
                            {{ $aircraft->registration . ' | ' . optional($aircraft->airline)->name . ' | ' . optional($aircraft->subfleet)->name }}
                            ...
                            @foreach ($pax_load_sheet as $pfare)
                                <div class="col-md">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input id="LoadFare{{ $pfare['id'] }}" type="text" class="form-control"
                                            value="{{ $pfare['count'] }}" disabled>
                            ...
                            @foreach ($cargo_load_sheet as $cfare)
                                <div class="col-md">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input id="LoadFare{{ $cfare['id'] }}" type="text" class="form-control"
                                            value="{{ number_format($cfare['count']) . ' ' . $units['weight'] }}" disabled>
                                        <span class="input-group-text">
                                            ...
                                            @else
                                                Max:
                                            @endif
                                            {{ number_format($cfare['capacity'] - $tbagload) . ' ' . $units['weight'] }}
                                        </span>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        @if (isset($tpayload) && $tpayload > 0)
                            ...
                            <div class="row row-cols-md-2 row-cols-lg-4 mb-1">
                                    ...
                                    <div class="col-md">
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-text"><i class="fas fa-users"
                                                    title="Passenger Weight"></i></span>
                                            <input id="tdPaxLoad" type="text" class="form-control"
                                                value="{{ number_format($tpaxload) . ' ' . $units['weight'] }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-text"><i class="fas fa-suitcase"
                                                    title="Baggage Weight"></i></span>
                                            <input id="tdBagLoad" type="text" class="form-control"
                                                value="{{ number_format($tbagload) . ' ' . $units['weight'] }}" disabled>
                                        </div>
                                    </div>
                                @endif
                                @if ($tpaxload && $tcargoload)
                                    <div class="col-md">
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-text"><i class="fas fa-dolly-flatbed"
                                                    title="Cargo Weight"></i></span>
                                            <input id="tdCargoLoad" type="text" class="form-control"
                                                value="{{ number_format($tcargoload) . ' ' . $units['weight'] }}" disabled>
                                        </div>
                                    </div>
                                @endif
                                <div class="col-md">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input id="tdPayload" type="text" class="form-control"
                                            value="{{ number_format($tpayload) . ' ' . $units['weight'] }}" disabled>
                                    </div>
                                </div>
                            </div>
                        @endif
            ...
            <div class="col-lg-4">
                ...
                @if (Theme::getSetting('simbrief_extrafuel'))
                    <div class="card mb-2">
                        ...
                        <div class="card-body p-1">
                            <div class="input-group input-group-sm">
                                <span class="input-group-text col-md-4">Minimum Block Fuel <i
                                        class="fas fa-info-circle mx-2 text-info"
                                        title="Holds already on board fuel from previous flight or defines the minimum block fuel"></i></span>
                                <input class="form-control form-control-sm" id="minfob" name="minfob" type="number"
                                    placeholder="0.0" min="0" max="9999" step="0.1"
                                    value="{{ round($aircraft->fuel_onboard->local() / 1000, 1) }}" />
                                <input type='hidden' name="minfob_units" value="wgt">
                            </div>
                            <div class="input-group input-group-sm">
                                <span class="input-group-text col-md-4">Minimum Arrival Fuel <i
                                        class="fas fa-info-circle mx-2 text-info"
                                        title="Forces minimum fuel over destination (FOD)"></i></span>
                                <input class="form-control form-control-sm" id="minfod" name="minfod" type="number"
                                    placeholder="0.0" min="0" max="9999" step="0.1" />
                                <input type='hidden' name="minfod_units" value="wgt">
                            </div>
                            <hr class="my-1 px-1">
                            <div class="input-group input-group-sm">
                                <span class="input-group-text col-md-4">MEL Fuel <i
                                        class="fas fa-info-circle mx-2 text-info"
                                        title="When weight is selected it should be metric tonnes or 1000's of pounds"></i></span>
                                <input class="form-control form-control-sm" id="melfuel" name="melfuel" type="number"
                                    placeholder="0.0" min="0" max="999" step="0.1" />
                            ...
                            <div class="input-group input-group-sm">
                                <span class="input-group-text col-md-4">ATC Fuel <i
                                        class="fas fa-info-circle mx-2 text-info"
                                        title="When weight is selected it should be metric tonnes or 1000's of pounds"></i></span>
                                <input class="form-control form-control-sm" id="atcfuel" name="atcfuel" type="number"
                                    placeholder="0.0" min="0" max="999" step="0.1" />
                            ...
                            <div class="input-group input-group-sm">
                                <span class="input-group-text col-md-4">WXX Fuel <i
                                        class="fas fa-info-circle mx-2 text-info"
                                        title="When weight is selected it should be metric tonnes or 1000's of pounds"></i></span>
                                <input class="form-control form-control-sm" id="wxxfuel" name="wxxfuel" type="number"
                                    placeholder="0.0" min="0" max="999" step="0.1" />
                            ...
                            <div class="input-group input-group-sm">
                                <span class="input-group-text col-md-4">OPN Fuel <i
                                        class="fas fa-info-circle mx-2 text-info"
                                        title="When weight is selected it should be metric tonnes or 1000's of pounds"></i></span>
                                <input class="form-control form-control-sm" id="addedfuel" name="addedfuel"
                                    type="number" placeholder="0.0" min="0" max="999" step="0.1" />
                            ...
                            <hr class="my-1 px-1">
                            <div class="input-group input-group-sm">
                                <span class="input-group-text col-md-4">Fuel Tankering <i
                                        class="fas fa-info-circle mx-2 text-info"
                                        title="Metric tonnes or 1000's of pounds"></i></span>
                                <input class="form-control form-control-sm" id="tankering" name="tankering"
                                    type="number" placeholder="0.0" min="0" max="60" step="0.1" />
                                @if (Theme::getSetting('simbrief_tankering'))
                                    <span
                                        class="input-group-text input-group-text-append col-md-4">{!! DT_CheckTankering($flight, $aircraft) !!}</span>
                                @endif
                ...
                <input type="hidden" id="acdata" name="acdata"
                    value="{'extrarmk':'{{ $sb_rvr . $sb_callsign . $sb_ivaova . $sb_rmk }}','paxwgt':{{ round($pax_weight) }}, 'bagwgt':{{ round($bag_weight) }}}"
                    readonly>
                ...
                @if ($tcargoload)
                    <input type='hidden' id='cargo' name='cargo'
                        value="{{ number_format($tcargoload / 1000, 1) }}">
                @else
